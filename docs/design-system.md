...
| Token                                   | Valeur               | Usage                         |
| --------------------------------------- | -------------------- | ----------------------------- |
| `--mp-primary`                          | `#C70039` (crimson)  | couleur de marque, CTA, liens |
...
Persona (profils communautaires) : `--mp-otaku` `#E91E8C`, `--mp-cosplayer` `#9B59B6`, `--mp-gamer` `#27AE60`, `--mp-creatif` `#F39C12`, `--mp-sakura` `#E7A0A8`.

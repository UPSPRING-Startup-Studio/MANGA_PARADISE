...
/**
 * Composant de prévisualisation du Line-Up avec export PNG
 * Formats supportés:
...
const LineUpPreview = ({
  ...
  const [format_, setFormat_] = useState<'story' | 'post'>(initialFormat);
  ...
  const aspectRatio = format_ === 'story' ? '9/16' : '4/5';

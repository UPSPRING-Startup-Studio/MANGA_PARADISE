...
import { Sparkles, Save, Gamepad2, X, Eye, EyeOff } from "lucide-react";
...
export const OtakuModal = ({ isOpen, onClose, profile }: OtakuModalProps) => {
  ...
  useEffect(() => {
    if (profile && isOpen) {
      ...
      setIsPublic(profile.privacy_settings?.show_otaku !== false);
    }
  }, [profile, isOpen]);
